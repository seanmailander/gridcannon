...
export const greatRun = {
  ...
  grid: [
    [],
    [{ card: 2, suit: "" }, { suit: "s", card: 11 }, { destroyed: true }],
    [
      { card: 2, suit: "" },
      { suit: "s", card: 13 },
    ],
    ...
    [],
    [{ card: 2, suit: "" }, { suit: "c", card: 11 }, { destroyed: true }],
    [
      { suit: "s", card: 10 },
      { suit: "c", card: 9 },
      { suit: "s", card: 9 },
    ...
    [{ suit: "c", card: 10 }],
    [{ card: 2, suit: "" }, { suit: "c", card: 13 }, { destroyed: true }],
    [
      { suit: "s", card: 3 },
      { card: 2, suit: "" },
      { suit: "h", card: 12 },
    ...
    [],
    [],
    [{ card: 2, suit: "" }, { suit: "d", card: 13 }, { destroyed: true }],
    [{ card: 2, suit: "" }, { suit: "h", card: 11 }, { destroyed: true }],
    [{ card: 2, suit: "" }, { suit: "s", card: 12 }, { destroyed: true }],
    [],
  ],
  bonus: [
    [
