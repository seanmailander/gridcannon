...
export const getClassForHintLookup = createSelector([getGamePhase], (gamePhase) => {
...
export default function Instructions() {
  ...
  return <>
    ...
    <ul>
      <li className={instructionStyles(SHUFFLE)}>Shuffle a deck of 52 cards</li>
    ...
    <ul>
      ...
      <li className={instructionStyles(ARMOR)}>Add an unplayable Pip to any Royal</li>
    </ul>
    ...
    <ul>
      ...
      <li className={instructionStyles(ACE)}>Play an Ace to reset any stack</li>
      <li className={instructionStyles(JOKER)}>Play a Joker to recall any stack</li>
    </ul>
    ...
    <ul>
      ...
      <li className={instructionStyles(LOSENOCARD)}>LOSE: No cards remain to play</li>
